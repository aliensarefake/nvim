  ...
  -- LSP Configuration
  {
    ...
    config = function()
      ...
      require("mason-lspconfig").setup({
        ensure_installed = {
          "clangd",      -- C/C++
          "ts_ls",       -- JavaScript/TypeScript (updated name)
          "pyright",     -- Python
          "lua_ls",      -- Lua
          "rust_analyzer", -- Rust
          "solidity",    -- Solidity
        ...
        handlers = {
          ...
          function(server_name)
            ...
            if server_name == "clangd" or server_name == "ts_ls" or server_name == "pyright" or server_name == "lua_ls" or server_name == "rust_analyzer" or server_name == "solidity" or server_name == "move_analyzer" then
              return
            end
